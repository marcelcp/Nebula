...
public class SampleData {
    ...
    public static List<Note> getSampleNotes(){
        ...
        note1.setContent("We went to Disneyland today and the kids had lots of fun!".getBytes());
        ...
        note2.setContent("I went to the Gym today and I got a lot of exercises".getBytes());
        ...
        note3.setContent("I will like to write a blog post about how to make money online".getBytes());
        ...
        note4.setContent("Today I found a recipe to make cup cake from www.google.".getBytes());
        ...
        note5.setContent("Today I attended a developer's networking event and it was great".getBytes());
